<template>
  <div class="container">
    ...
    <div class="search-input">
      <span class="search-input-label">Search for Ingredients: </span>
      <input class="search-text" type="text" v-model="searchInputValue" @keyup="suggestSearchTerm()"/>
    ...
    <div class="no-ingredients" v-show="filteredIngredientList.length === 0">
      ...
      <div class="add-ingredient-container">
        <form
          v-show="filteredIngredientList.length === 0"
...
export default {
  ...
  methods: {
    ...
    addIngredient() {
      ingredientService.addIngredient(this.newIngredient).catch((error) => {
        console.error(error);
      });
    },
  },
